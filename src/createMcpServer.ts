...
import { createWatchTool, WatchInputSchema, WatchShape, type WatchHandler } from "./tools/watch.js";
...
export async function createMcpServerBundle(options: McpServerBundleOptions = {}): Promise<McpServerBundle> {
  ...
  server.registerTool(
    "import_chatgpt_export",
    {
      ...
      description: "Convert a ChatGPT export ZIP into Markdown and automatically reindex the output directory.",
